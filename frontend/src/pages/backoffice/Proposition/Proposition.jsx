      ...
      <div className="space-y-12">
        <header>
          ...
          <p className="italic">
            ...
            le{" "}
            <Underline>
              {new Date(info.proposition_date).toLocaleString().split(" ")[0]}
            </Underline>
          </p>
          <p>
        ...
        <section className="">
          ...
          <div
            /* style={{display:"grid", gridTemplateColumns:"repeat(autofit, minmax(350px, 400px)", gap:"60px"}} */ className="grid grid-cols-3 gap-20"
          >
            <div>
              ...
              >
                <Boldify>Statut : {info.offer_status}</Boldify>
              </p>
              <p>
